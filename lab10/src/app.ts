...
import { renderLogin, handleLogin, handleLogout } from "./controllers/authController";
import { getTodoList, createTodo, removeTodo } from "./controllers/todoController";
...
app.get("/todos", requireLogin, getTodoList);
